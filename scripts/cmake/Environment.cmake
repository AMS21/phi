...
elseif(MSVC)
  ...
  elseif(MSVC_VERSION EQUAL 1937)
    ...
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1938)
    phi_set_cache_value(PHI_MSVC_VERSION 14.38)
    phi_set_cache_value(PHI_MSVC_NAME "Visual Studio 2022 Version 17.8")
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1939)
    ...
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1940)
    phi_set_cache_value(PHI_MSVC_VERSION 14.40)
    phi_set_cache_value(PHI_MSVC_NAME "Visual Studio 2022 Version 17.10")
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1941)
    phi_set_cache_value(PHI_MSVC_VERSION 14.41)
    phi_set_cache_value(PHI_MSVC_NAME "Visual Studio 2022 Version 17.11")
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1942)
    phi_set_cache_value(PHI_MSVC_VERSION 14.42)
    phi_set_cache_value(PHI_MSVC_NAME "Visual Studio 2022 Version 17.12")
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  elseif(MSVC_VERSION EQUAL 1943)
    phi_set_cache_value(PHI_MSVC_VERSION 14.43)
    phi_set_cache_value(PHI_MSVC_NAME "Visual Studio 2022 Version 17.13")
    phi_set_cache_value(PHI_MSVC_YEAR "2022")
  else()
